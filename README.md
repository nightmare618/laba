...
2.	(Не)Создан файл /etc/docker/daemon.json для настройки зеркал репозиториев.
...
docker execa -it custom-nginx-t2 base64 /usr/share/nginx/html/index.html
...
```
doc
ker exec centos-container touch /data/from-centos.txt
```
